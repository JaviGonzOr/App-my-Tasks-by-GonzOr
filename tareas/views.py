...
from .forms import TareaForm, Proveedor, ProductoForm
from .models import Tarea, Proveedor, Producto, ImagenTarea
...
def grafico(request):
    elementos = Tarea.objects.all()
    modelos = ""
    cantidades = ""
    for i in elementos:
        modelos = modelos + "'" + str(i.modelo) + "'," 
        cantidades = cantidades + str(i.cantidad) + ","
